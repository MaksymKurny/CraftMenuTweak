...
local LOCALE =
{
	...
	zh =
	{
		...
		ICON_SIZE_HOVER = "用于调整角色头像尺寸图标的大小。",
		FAST_CRAFT_HOVER = "允许你使用按键点击道具直接制作",
		SUB_INGR_HOVER = "鼠标悬停在配方上时，下方显示所需材料",
		CRAFT_SKIN_HOVER = "配方图标替换为其最近使用的皮肤图标",
		FUN_KEY_HOVER = "制作栏内用此按键添加新选项卡，收藏夹内用此按键来调序\n前者需要使用Tabs服务端模组和打开Tabs模组支持",
		...
		FAST_CRAFT_2 = "右键",
		FAST_CRAFT_3 = "Ctrl",
		FAST_CRAFT_1_HOVER = "按住右键以停用模式",
		FAST_CRAFT_2_HOVER = "按住右键并单击",
		FAST_CRAFT_3_HOVER = "按住Ctrl并单击"
	},
}
