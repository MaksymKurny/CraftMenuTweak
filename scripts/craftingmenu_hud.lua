...
self.RefreshCraftingHelpText = function(self, controller_id)
	if self.filter_panel.focus then
		return TheInput:GetLocalizedControl(controller_id, CONTROL_ACCEPT).." "..STRINGS.UI.HUD.SELECT.." "..TheInput:GetLocalizedControl(controller_id, CONTROL_MENU_MISC_1).." "..STRINGS.UI.CRAFTING_MENU.PIN
	end
